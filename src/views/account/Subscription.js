...
import FarmrSubscription from "../misc/FarmrSubscription";
...
class Subscription extends React.Component {
  ...
  componentDidMount() {
    this.stripeCheckout = window.StripeCheckout.configure({
      ...
      name: "Farmr",
      description: "Subscribe to Farmr",
    ...
    return (
      <FarmrSubscription>
        {({ error, isLoading, subscription }) => {
          ...
          const cancelConfirmation = `Are you sure you want to cancel your subscription? You won't have access to paid Farmr features.`;
